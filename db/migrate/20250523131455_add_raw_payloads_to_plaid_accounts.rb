class AddRawPayloadsToPlaidAccounts < ActiveRecord::Migration[7.2]
  def change
    add_column :plaid_items, :raw_payload, :json, default: {}
    add_column :plaid_items, :raw_institution_payload, :json, default: {}

    change_column_null :plaid_items, :plaid_id, false
    add_index :plaid_items, :plaid_id, unique: true

    add_column :plaid_accounts, :raw_payload, :json, default: {}
    add_column :plaid_accounts, :raw_transactions_payload, :json, default: {}
    add_column :plaid_accounts, :raw_investments_payload, :json, default: {}
    add_column :plaid_accounts, :raw_liabilities_payload, :json, default: {}
