...
class CreateGoodJobs < ActiveRecord::Migration[7.2]
  def change
    ...
    create_table :good_job_executions do |t|
      t.timestamps
    ...
    create_table :good_job_processes do |t|
      t.timestamps
      t.json :state
    end

    create_table :good_job_settings do |t|
      t.timestamps
      t.text :key
      t.json :value
    ...
    add_index :good_jobs, :labels, where: "(labels IS NOT NULL)", name: :index_good_jobs_on_labels
